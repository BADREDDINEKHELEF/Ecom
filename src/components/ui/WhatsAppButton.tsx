...
export default function WhatsAppButton({ message, variant = 'float', className }: WhatsAppButtonProps) {
  ...
  if (variant === 'inline') {
    return (
      <a
        ...
        className={`flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-5 rounded-xl transition-colors ${className ?? ''}`}
      >
  ...
  return (
    ...
    >
      ...
      <span className="relative w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all hover:scale-110 active:scale-95">
