    ...
    lessons: [
      ...
      },
      {
        ...
        steps: [
          ...
          { text: 'Le reversement du montant (déduction des commissions) est effectué selon le calendrier de votre contrat vendeur. Consultez "Revenus & Paiements" dans votre tableau de bord pour le suivi.' },
    ...
    lessons: [
      ...
      },
      {
        ...
        steps: [
          ...
          { text: 'Prix : calculez votre prix de revient (achat + frais d\'expédition + commission ShopDZ 10%) et ajoutez votre marge.' },
    ...
    lessons: [
      {
        ...
        steps: [
          ...
          { text: 'Commission ShopDZ : 10% du prix de vente. Si vous vendez à 2000 DA, ShopDZ prend 200 DA.' },
          ...
          { text: 'Formule : Prix minimum = (Achat + Emballage + Livraison) / (1 - 0.10) + marge souhaitée. Exemple : (500 + 80 + 450) / 0.9 = 1144 DA minimum pour 0% de marge — ajoutez 600-800 DA de marge.' },
