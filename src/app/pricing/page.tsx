...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Suppression branding · domaine personnalisé', included: false },
    ],
  },
  {
    id: 'business',
    ...
    trial: true,
    features: [
      { text: 'Jusqu\'à 10 boutiques · produits illimités', included: true },
      ...
      { text: 'Accès API & intégrations avancées', included: true },
    ],
  },
]
