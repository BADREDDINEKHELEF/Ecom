...
import { ArrowRight, Minus, Plus, ShoppingCart, Star, Package, Truck, Shield, CheckCircle, Users, Loader2 } from 'lucide-react'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
        ...
        <div className="space-y-3">
          <div
            className="relative aspect-square rounded-2xl overflow-hidden bg-gray-100 cursor-zoom-in select-none hidden lg:block"
          ...
          <div className="relative aspect-square rounded-2xl overflow-hidden bg-gray-100 lg:hidden">
            <Image
              src={product.images[selectedImage]}
              alt={product.name}
              fill
          ...
          {product.stock > 0 && (
            ...
            >
              ...
              <div className="flex-1">
                <p className="font-black text-base leading-tight">Commander en 1 clic via WhatsApp</p>
                <p className="text-xs text-green-100 mt-0.5">Message pré-rempli · Réf. unique · Réponse rapide</p>
              </div>
