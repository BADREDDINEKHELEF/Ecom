...
export const metadata: Metadata = {
  title: "Conditions d'utilisation — StoreDz",
  description: "Conditions générales d'utilisation de la plateforme StoreDz.",
}
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed text-gray-700">
            ...
            <section>
              ...
              <p>
                En accédant ou en utilisant StoreDz (&quot;la Plateforme&quot;), vous acceptez d&apos;être lié par les présentes
            ...
            <section>
              ...
              <p>
                StoreDz est une place de marché en ligne qui met en relation des acheteurs et des vendeurs indépendants
                basés en Algérie. StoreDz n&apos;est pas le vendeur des produits listés — chaque produit est vendu par
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Contacter le vendeur ou le support StoreDz dans les <strong>7 jours</strong> suivant la livraison pour tout problème</li>
            ...
            <section>
              ...
              <p>Les éléments suivants sont strictement interdits sur StoreDz :</p>
            ...
            <section>
              ...
              <p>
                ...
                de l&apos;organisation de la logistique de retour. StoreDz peut intervenir en tant que médiateur dans les
            ...
            <section>
              ...
              <p>
                StoreDz fournit la Plateforme &quot;en l&apos;état&quot; et ne garantit pas un service ininterrompu
                ou sans erreur. Dans les limites autorisées par la loi algérienne, la responsabilité de StoreDz
            ...
            <section>
              ...
              <p>
                La marque, le logo et le design de la Plateforme StoreDz sont la propriété de StoreDz. Les vendeurs
                conservent la propriété de leur contenu produit. En listant sur StoreDz, les vendeurs accordent à
                StoreDz une licence non exclusive pour afficher et promouvoir leurs produits sur la Plateforme.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                StoreDz peut mettre à jour les présentes conditions à tout moment. La poursuite de l&apos;utilisation
            ...
            <section>
              ...
              <p>
                ...
                <a href="mailto:legal@storedz.dz" className="text-indigo-600 hover:underline">
                  legal@storedz.dz
                </a>
              </p>
            </section>
